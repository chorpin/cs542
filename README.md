...
t7 = train_pic[0, :]
t7 = t7.reshape([-1, 262144])
t7_label = np.array([0, 1])
t7_label = t7_label.reshape([-1, 2])
t7_result = h_conv1.eval(feed_dict={X_: t7, y_: t7_label, keep_prob: 1.0})
print(t7_result.shape)
for _ in range(32):
    show_img = t7_result[:, :, :, _]
